...
def monster_power_from_xml(root, monster):
  ...
  if root.find("./Trigger") is not None:
    ...
    a.attack= "%s +%d vs. %s"(
      ...
      int(root.find("./Attacks/MonsterAttack/AttackBonuses/MonsterPowerAttackNumber").get('FinalValue')),
    ...
    a.hit= " ".join([root.findtext("./Attacks/MonsterAttack/Hit/Damage/Expression",""),
                     root.findtext("./Attacks/MonsterAttack/Hit/Damage/Description","")])
    a.miss= " ".join([root.findtext("./Attacks/MonsterAttack/Miss/Damage/Expression",""),
                      root.findtext("./Attacks/MonsterAttack/Miss/Damage/Description","")])
