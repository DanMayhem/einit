...
class MonsterActionModel(_db.Model):
  ...
  trigger = _db.Column(_db.String(256))
  trigger_usage = _db.Column(_db.String(256))
  attack = _db.Column(_db.String(64))
  hit = _db.Column(_db.String(256))
  miss = _db.Column(_db.String(256))
  effect = _db.Column(_db.String(256))
  secondary_attack = _db.Column(_db.String(256))
  aftereffect = _db.Column(_db.String(256))
